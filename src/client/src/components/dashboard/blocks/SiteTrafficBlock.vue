...
<template>
  <div class="bg-white p-7 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_12px_rgba(0,0,0,0.04)] group/block relative">
    <div class="flex items-center justify-between mb-5">
      <span class="text-xs font-bold tracking-[0.1em] uppercase text-gray-500">Site Traffic</span>
    </div>

    <!-- Hero -->
    <div class="mb-1">
      <div class="font-mono text-[34px] font-semibold leading-none text-slate-900">{{ formatNum(data.totalSessions) }}</div>
      <div class="text-xs text-gray-400 mt-1 mb-1.5">Total website sessions from GA4</div>
    ...
    <div class="flex items-baseline justify-between mb-2">
      <div class="text-[13px] font-bold text-slate-900">Traffic Sources</div>
