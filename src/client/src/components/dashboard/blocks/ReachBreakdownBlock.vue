...
<template>
  <div class="bg-white p-7 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_12px_rgba(0,0,0,0.04)] group/block relative">
    <div class="flex items-center justify-between mb-5">
      <span class="text-[10px] font-bold tracking-[0.1em] uppercase text-gray-500">Reach Breakdown</span>
    </div>

    <!-- Hero -->
    <div class="mb-1">
      <div class="font-mono text-[34px] font-semibold leading-none text-slate-900">{{ formatNum(data.total) }}</div>
      <div class="text-[10px] text-gray-400 mt-1 mb-1.5">Total impressions across all channels</div>
    ...
    <div class="text-[11px] font-bold text-slate-900 mb-2">Where Your Reach Comes From</div>
