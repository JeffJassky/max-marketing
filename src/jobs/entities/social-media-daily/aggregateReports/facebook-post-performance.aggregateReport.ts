...
export const facebookPostPerformance = new AggregateReport({
  id: "facebookPostPerformance",
  description: "Detailed organic performance for Facebook posts.",
  source: socialMediaDaily,
  predicate: "platform = 'facebook' AND (engagement > 0 OR impressions > 0)",
  window: {
    id: "last_90d",
    lookbackDays: 90,
    dateDimension: "date",
