...
export const googleAdsCampaignPerformance = new AggregateReport({
  ...
  output: {
    ...
    metrics: {
      ...
      revenue: { aggregation: "sum", display: { format: "currency", label: "Revenue", description: "Total revenue from orders attributed to your Google Ads, based on cart data. This represents actual purchase revenue, not general conversion value." } },
